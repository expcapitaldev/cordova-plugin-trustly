...
public class TrustlyWebView extends WebView {
	...
	public TrustlyWebView(Activity activity, String url, TrustlyEventHandler trustlyEventHandler) {
		super(activity);

		tryOpeningUrlInWebView(activity, url, trustlyEventHandler);
	}

	private void tryOpeningUrlInWebView(Activity activity, String url, TrustlyEventHandler trustlyEventHandler) {
		try {
			// Enable javascript and DOM Storage
			configWebSettings(this);

			// setWebViewClient set in TrustlyActivity.java
